export const ContactForm = () => {
  return (
    <div className="flex justify-center items-center  bg-neutral-950 font-inter font-medium text-gray-300 mt-6 p-4">
      <form action="submit" className=" w-full max-w-200 flex flex-col gap-6 h-100">
        {/* Top Inputs */}
        ...
        <div className="w-full">
          <textarea
            ...
            className="w-full bg-neutral-950 border border-dark-borders/50 
            rounded-lg px-4 py-3 text-white placeholder-secondary-text focus:outline-none
            focus:border-lavender/50 focus:ring-0.5 focus:ring-lavender transition-all duration-200 resize-none"></textarea>
        </div>
        ...
        <div className="flex justify-center items-center">
          <button
            type="submit"
            className="w-fit cursor-pointer bg-white text-black font-semibold rounded-lg 
            px-4 py-3 hover:bg-gray-200 active:scale-[0.98] transition-all duration-200">
            Send Message
          </button>
        </div>
      </form>
