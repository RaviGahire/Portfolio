...
export const Home = () => {
  return (
    <>
      <div className="relative bg-zinc-950 text-neutral-50 h-auto md:h-screen bg-ye max-w-screen overflow-hidden">
        ...
        <section
          ...
          className="relative min-h-screen text-center flex flex-col justify-center items-center"
        >
          <div className="max-w-3xl  flex mx-auto flex-col justify-center items-center gap-8">
            {/* Badge */}
            <Badge
