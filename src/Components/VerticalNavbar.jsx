...
export const VerticalNavbar = () => {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 w-[330px] text-white transition-transform duration-300 shadow-lg ${isScrolled ? "translate-x-0" : "-translate-x-full"
        }`}
    >
     <div className="w-full min-h-screen flex flex-col justify-center items-center bg-white dark:bg-gradient-to-b from-gray-950 to-gray-900 text-white px-4 py-10">
  {/* Header Section */}
  ...
  {/* Divider */}
  <div className="w-80 my-8 h-px bg-amber-500 dark:bg-slate-700 rounded-full"></div>
