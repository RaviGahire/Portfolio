...
export const Sidebar = () => {
    ...
    return (
        <>
<aside
  className={`hidden lg:flex flex-col fixed left-0 top-0 w-[330px] h-screen 
  text-white bg-white dark:bg-linear-to-b from-gray-950 to-gray-900 
  transition-transform duration-300 ease-in-out 
  ${isScrolled ? '-translate-x-[340px]' : 'translate-x-0'}`}
>
  {/* WRAPPER (vertical scroll only) */}
  <div
  ...
  >
    ...
    <div className="text-center py-4 shrink-0">
      ...
      {/* Animated Code Snippet */}
      <div className="p-3 shadow-lg overflow-hidden mt-5">
    ...
    {/* Divider */}
    <div className="w-80 mx-auto h-px bg-amber-500 dark:bg-slate-600 rounded-full mt-4 shrink-0"></div>

    {/* ==== GitHub Stats ==== */}
    <div className="bg-transparent rounded-xl p-3 shadow-lg mt-4 shrink-0">
        ...
        <>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
            <div className="text-center">
              <div className="text-xl font-bold text-gray-600 dark:text-yellow-400">
    ...
    {/* Divider */}
    <div className="w-80 mx-auto h-px mt-4 bg-amber-500 dark:bg-slate-700 rounded-full shrink-0"></div>
